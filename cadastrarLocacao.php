...
try {
  ...
  //locacao's variables
  $gestor = filter_var($_POST['gestor'], FILTER_SANITIZE_NUMBER_INT);
  $locador = filter_var($_POST['locador'], FILTER_SANITIZE_NUMBER_INT);
  $situacao = filter_var($_POST['situacao']);
  $centroCusto = filter_var($_POST['centroCusto'], FILTER_SANITIZE_NUMBER_INT);
  ...
  $queryLocacao = "INSERT INTO locacao (situacao, id_centro_custo, inicio_locacao, termino_locacao, vistoria_entrada, vistoria_saida, observacoes, qtd_quartos, qtd_banheiros, qtd_vagas_garagem, id_gestor, id_locador, id_endereco) VALUES (:situacao, :centroCusto, :inicio_locacao, :termino_locacao, :vistoriaEntrada, :vistoriaSaida, :observacoes, :qtd_quartos, :qtd_banheiros, :qtd_vagas_garagem, :gestor, :locador, :idEndereco)";
