...
<head>
  ...
  <title>Controle de Locação - Gestores</title>
...
<nav class="navbar navbar-expand-lg bg-body-tertiary sticky-top">
  ...
  <div class="hstack gap-1 px-2 mb-3">
    ...
    <a href='./form-cadastrar-pessoa.php' class='btn btn-warning'>Cadastrar Gestor</a>
        ...
        <?php
          ...
          try {
            if(!isset($_GET['filtrar'])){
              ...
              $sql = 'SELECT idgestor, nome, email, telefone_1 FROM gestor';
              ...
              while ($linha = $consulta->fetch(PDO::FETCH_ASSOC)) {
                echo "  <tr class='text-center'>
                          ...
                          <td><a href='./ver-gestor.php?idgestor=$linha[idgestor]' class='btn btn-primary p-2'><i class='fa-solid fa-eye fa-xl'></i></a></td>
                          <td><a href='./form-editar-gestor.php?idgestor=$linha[idgestor]' class='btn btn-laranja p-2'><i class='fa-solid fa-pencil fa-xl'></i></a></td>
                        </tr>
                ";
              }
            } else {
              $filtrar = filter_var($_GET['filtrar']);
              $sql = "SELECT idgestor, nome, email, telefone_1 
              FROM gestor
